...
import { createSnippet, getModeMeta, getStatusTone } from '../utils';
      ...
      <ScrollView style={styles.screen} contentContainerStyle={styles.contentContainer}>
        <View style={styles.hero}>
          ...
          <View style={styles.metricRow}>
            ...
            <MetricCard
              label="Documents"
              value={documentsDirectory.startsWith('Unavailable:') ? 'Unavailable' : 'Ready'}
            />
          ...
          <Card>
            <View style={styles.cardHeader}>
              <View>
                ...
                <Text style={styles.cardSubtitle}>
                  Switch between app documents and a custom folder, then experiment freely.
                </Text>
              </View>
              <View
                style={[
            ...
            <ResultPanel title="Status" value={status} accent="#205a43" textTestID="status-text" />
          </Card>
        )}
        ...
        {showEditor && (
          <Card>
            ...
            <View style={styles.snippetCard}>
              ...
              <Text style={styles.snippetText}>{createSnippet(filePath, downloadUrl)}</Text>
            </View>
          </Card>
        )}
        ...
        {(showFileActions || showDirectoryActions || showRemoteActions) && (
          <Card>
            ...
            <Text style={styles.cardSubtitle}>
              Each action updates the result panels below so you can see the current state.
            </Text>
            ...
            {showFileActions && (
              <ActionSection
                ...
                <ResultPanel title="Exists" value={existsResult} accent="#5b4b9a" textTestID="exists-result" />
                <ResultPanel title="Read result" value={readResult} accent="#8f304d" textTestID="read-result" />
              </ActionSection>
            )}
            ...
            {showDirectoryActions && (
              <ActionSection
                ...
                />
                <ResultPanel title="Stat" value={statResult} accent="#5f3c85" textTestID="stat-result" />
              </ActionSection>
            )}
              ...
              <ActionSection
                ...
                <View style={styles.buttonGrid}>
                  <ActionTile
                    ...
                    caption="Fetch a remote text file into the current path."
                    onPress={() =>
                      runAction('downloadFile', async () => {
                        const result = await ReactNativeFilesystem.downloadFile(downloadUrl, filePath);
        ...
        {showResults && (
          <Card>
            ...
            <Text style={styles.cardSubtitle}>
              These panels mirror the native module responses so you can validate behavior quickly.
            </Text>
        ...
        {showPreview && (
          <Card>
            ...
            <Text style={styles.cardSubtitle}>
              The bundled native view is shown below so the example demonstrates both module and view APIs.
            </Text>
